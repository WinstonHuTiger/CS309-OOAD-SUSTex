...
(function(mod) {
  ...
  var HINT_MENU_CLASS = "ant-select-dropdown-menu ant-select-dropdown ant-select-dropdown ant-select-dropdown--single ant-select-dropdown-placement-bottomLeft";
  var HINT_ELEMENT_CLASS        = "ant-select-dropdown-menu-item";
  var ACTIVE_HINT_ELEMENT_CLASS = "ant-select-dropdown-menu-item-active";
  ...
  function Widget(completion, data) {
    ...
    hints.className = HINT_MENU_CLASS + " " + theme;
